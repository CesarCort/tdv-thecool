...
function create_TDV_order($order_id){
	...
	$login_url = "https://tdv4.textildelvalle.pe/TiendaVirtual_desa/api/login";
	...
	if ( is_wp_error( $login_response ) or wp_remote_retrieve_response_code( $login_response ) != 200 ) {
		...
		$create_order_tdv_url = "https://tdv4.textildelvalle.pe/TiendaVirtual_desa/api/Pedido/create";
